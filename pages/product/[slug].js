...
import { getDiscountedPricePercentage, formatearDinero } from "@/utils/helper";
...
const ProductDetails = ({ product, products }) => {
  ...
  return (
    <div className="w-full md:py-20">
      <ToastContainer />
      <Wrapper>
        <div className="flex flex-col lg:flex-row mb:px-10 gap-[50px] lg:gap-[100px]">
          {/* Left colum start */}
          ...
          <div className="flex-[1] py-3">
              ...
              {p.original_price && (
                <>
                  <p className="text-base  font-medium line-through">
                    {formatearDinero(p.original_price)}
                  </p>
            ...
            <div>
              <div className="text-lg font-bold mb-5">Products Details</div>
